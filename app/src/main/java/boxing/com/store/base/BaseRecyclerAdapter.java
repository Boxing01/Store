...
/**
 * Created by liuyuli on 2017/5/31 0031.
 */
        ...
        rView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if ((newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 == getItemCount())
                        || (newState == RecyclerView.SCROLL_STATE_SETTLING && lastVisibleItem + 1 == getItemCount())) {
            ...
            if (listener != null) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        listener.onItemClickListener(BaseRecyclerAdapter.this, (Integer) v.getTag());
                    }
                });
                holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
                    public boolean onLongClick(View v) {
                        listener.onItemLongClickListener(BaseRecyclerAdapter.this, (Integer) v.getTag());
                        return true;
                    }
                });
            }
